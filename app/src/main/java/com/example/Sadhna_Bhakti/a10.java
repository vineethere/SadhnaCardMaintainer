...
public class a10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        no.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(a10.this, a11.class));finish();
            }
        });
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(h)) {
                    Toast.makeText(a10.this, "Please enter  something or select no", Toast.LENGTH_SHORT).show();
                }
                else{
                    ans = h;
                    DbHandler db=new DbHandler(a10.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(a10.this, a9.class));
        finish();
    }
}