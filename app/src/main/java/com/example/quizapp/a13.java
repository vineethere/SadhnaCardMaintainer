        ...
        no.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(m) || TextUtils.isEmpty(h)) {
                    Toast.makeText(a13.this, "No selected", Toast.LENGTH_SHORT).show();
                }
                ans="No";
                DbHandler db=new DbHandler(a13.this);
                db.update_ans13(date,ans);
                Toast.makeText(a13.this, ans, Toast.LENGTH_SHORT).show();
                startActivity(new Intent(a13.this, a14.class));
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(m)) {
                    Toast.makeText(a13.this, "Please enter some minute or select no", Toast.LENGTH_SHORT).show();
                }
