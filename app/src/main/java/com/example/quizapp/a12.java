        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(m)) {
                    Toast.makeText(a12.this, "Please enter some minute or select no", Toast.LENGTH_SHORT).show();
                }
